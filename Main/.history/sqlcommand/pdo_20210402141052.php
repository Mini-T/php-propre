...
function Register($insert, $pdo, $tablename, $colname1, $colname2, $colname3, $content1, $content2, $content3)
{
    $insert = $pdo->exec("INSERT INTO $tablename($colname1, $colname2, $colname3) VALUES ('$content1', '$content2', '$content3')");
}
