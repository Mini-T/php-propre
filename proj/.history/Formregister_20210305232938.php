            ...
            <form method="POST" action="#">
                ...
                <br>
                 ...
                 if (empty($_POST['email'])) {
                    echo "veuillez rentrer votre adresse mail"
                    ;
                } elseif (empty($_POST['Username'])) {
                    echo "veuiller rentrer votre Nom d'utilisateur ça sert des fois"
                    ;
                } elseif (empty($_POST['mdp'])) {
                    echo "veuiller définir votre mot de passe c'est important en vrai"
                    ;
                } else { ?>
                    <?php 
