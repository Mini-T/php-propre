            ...
            <form method="POST" action="#">
                ...
                try {
                    ...
                    if (!empty($_POST['Username']) and !empty($_POST['mdp'])) {
                        ...
                        // c'est le bordel je suis défoncé il est 2H13 au secours
                        if ($fetchassocshowLOGIN['mdp'] == true) {
                                session_start();
                                $safepostuser = addslashes($_POST['Username']);
                                $_SESSION['username'] = $safepostuser;
                                if (isset($_POST['stillConnect'])) {
                                setcookie('stillconnect', $_SESSION['username'], time() + 31536000);
                            }
