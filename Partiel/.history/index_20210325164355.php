    ...
    <div id="main">
        ...
        <div id="class1">
            ...
            <div id="cards">
                ...
                <div>
                    <ul id="liste">
                       <li><i class="fas fa-check"></i><p>Sans engagement</p></li>
                       <li><i class="fas fa-check"></i><p>Encadrement sportif</p></li>
                       <li><i class="fas fa-check"></i><p>Cours collectifs Live & vidéos
</p></li>
                       <li><i class="fas fa-check"></i><p>Cardio, musculation & Cross Training</p></li>
                    </ul>
                </div>
                </div>
            </div>
