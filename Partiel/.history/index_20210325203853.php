...
<body>
    <div id="main">
        ...
        <div class='newsletter'>
            ...
            <p class="prop">En vous inscrivant, vous acceptez de recevoir des lettres d’informations ou des messages informatifs de la commune du Séquestre. Vous affirmez aussi avoir pris connaissance de notre politique de confidentialité. Si vous êtes inscrit, vous pouvez vous désinscrire à tout moment à l’aide du lien de désinscription inclus dans les emails que vous recevrez ou en nous contactant à l’adresse 
