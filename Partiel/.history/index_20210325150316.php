...
<body>
    <div id="main">
        ...
        <div id="avantages">
            ...
            <div id="second">
                <div class="av">
                    <img src="icone.png" alt="" class="cardm">
                ...
                <div class="av">
                    <img src="arrows.png" alt="" class="cardm">
        ...
        <p class="cardp">C'est parti pour une nouvelle année
Avec Fabien et Julie.</p>
<a href="#">Réserver un coach personnel</a>
</div>
<div></div>
